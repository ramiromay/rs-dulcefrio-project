...
public class UpdateUserDialog extends JDialog
{
    ...
    private UUID employeeIdUpdate;
    private String currentDate;

    public UpdateUserDialog(UUID employeeIdUpdate) {
    ...
    {
        User user = employeeDao.getUserByEmployeeId(employeeIdUpdate);
        Employee employee = user.getEmployee();
        txtName.setText(employee.getName());
        txtLastName.setText(employee.getLastName());
        txtDate.setText(DateUtils.formatDate(employee.getAdmissionDate()));
        currentDate = DateUtils.formatDate(employee.getAdmissionDate());
    ...
    private void configureProperties()
    {
        ...
        setIconImage(((ImageIcon) SVGUtils.getSVGIcon(PathRS.SVG_MENU_ITEM.formatted("3"))).getImage());
        setTitle("Usuarios");
    ...
    private void configureComponents()
    {
        ...
        lbTitle = new JLabel("Modificar Usuario");
        lbTitle.putClientProperty(FlatClientProperties.STYLE, "" +
                "font:bold +10");
        mainPanel.add(lbTitle);

        description = new JLabel("¡Veamos que cambios tienes!");
        ...
        txtDate.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Ingrese su fecha de ingreso [dd/mm/yyyy]");
        ...
        txtPhone.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Ingrese su teléfono");
        ...
        FlatHelpButtonIcon helpIcon = new FlatHelpButtonIcon();
        helpButton = new JButton();
        helpButton.putClientProperty(FlatClientProperties.STYLE, "" +
                "background:null;" +
                "pressedBackground: null;" +
                "focusedBackground:null;" +
                "hoverBackground:null");
        helpButton.setBorder(null);
        helpButton.setToolTipText("NOTA: Si la contraseña esta vacía \nse mantendrá la contraseña actual");
        ...
        cmdRegister = new JButton("Actualizar");
        ...
        layout.setHorizontalGroup(layout.createParallelGroup()
                ...
                .addGroup(layout.createSequentialGroup()
                        .addComponent(lbPassword, GroupLayout.DEFAULT_SIZE,
                                500, Short.MAX_VALUE)
                        .addGap(5)
                        .addComponent(helpButton, GroupLayout.DEFAULT_SIZE,
    ...
    private void registerEmployee()
    {
        ...
        if (!DateUtils.isDateValid(date))
        {
            JOptionPane.showMessageDialog(
                    this,
                    "La fecha es inválida debe estar en formato dia/mes/año",
                    "Actualizar Usuario",
                    JOptionPane.ERROR_MESSAGE
            );
            txtDate.requestFocus();
        ...
        if (DateUtils.isDateBeforeCurrent(date, currentDate))
        {
            JOptionPane.showMessageDialog(
                    this,
        ...
        if (!password.isEmpty() && passwordStrengthStatus.getType() == 1)
        {
            JOptionPane.showMessageDialog(
                    this,
        ...
        if (employeeDao.isEmployeeExist(employeeIdUpdate, name, lastName))
        {
            JOptionPane.showMessageDialog(
                    this,
        ...
        if (employeeDao.isEmailExist(employeeIdUpdate, email))
        {
            JOptionPane.showMessageDialog(
                    this,
        ...
        if (userDao.isUsernameExist(employeeIdUpdate, username))
        {
            JOptionPane.showMessageDialog(
                    this,
        ...
        UUID employeeId = employeeDao.update(employeeIdUpdate, employee);
        UUID userId = userDao.update(employeeIdUpdate, user);
