package com.realssoft.dulcefrio.ui.components.calendar;
...
import com.realssoft.dulcefrio.ui.components.calendar.utils.CalendarCellListener;
import com.realssoft.dulcefrio.ui.components.calendar.utils.CellRenderCustom;
import com.realssoft.dulcefrio.ui.components.calendar.utils.PanelDateListener;
import com.realssoft.dulcefrio.ui.components.swing.DynamicCell;
import com.realssoft.dulcefrio.ui.components.swing.DynamicCellListener;
...
public class PanelDay extends DynamicCell<ModelDate> {
    ...
    public static final String DATE[] = {"Dom", "Lun", "Mar", "Mié", "Jue", "Vie", "Sáb"};
    ...
    private void init() {
        ...
        setDynamicCellRender(new CellRenderCustom<ModelDate>(mouse) {
            ...
            public void paint(Graphics2D g2, Rectangle rectangle) {
                ComponentsUtils.setRendering(g2);
