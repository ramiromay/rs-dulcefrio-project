...
public class ThemeMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Claro", new FlatSVGIcon(PathRS.SVG_LIGHT_MODE));
        buttonDark = new JButton("Oscuro", new FlatSVGIcon(PathRS.SVG_DARK_MODE));
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            buttonLighDark.setIcon(new FlatSVGIcon(PathRS.SVG_DARK_MODE));
        } else {
            buttonLighDark.setIcon(new FlatSVGIcon(PathRS.SVG_LIGHT_MODE));
        }
    }

    private void addStyle(JButton button, boolean isDark) {
        if (isDark) {
